...
public class Hints05 : MonoBehaviour
{
    public GameObject btnChoiParent;
    ButtonChoices05 btnChoiScript;
    public GameObject btnConParent;
    ButtonContainer05 btnConScript;
    int hint1 = 0;
    string[] answer = {"T","A","R","L","A","C","P","L","A","Z","A"};
    ...
    void Start()
    {
        btnChoiScript = btnChoiParent.GetComponent<ButtonChoices05>();
        btnConScript = btnConParent.GetComponent<ButtonContainer05>();
