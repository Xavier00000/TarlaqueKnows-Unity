using UnityEngine;
public class Hints04 : MonoBehaviour
{
    ...
    public void HintClicked01()
    {
        ...
        {            
            for(int ctr=0; ctr<btnConScript.btnContainer.Length; ctr++)
            {
                ...
                {
                    if(btnConScript.btnConText[ctr].text=="PILIPINAS KONG MAHAL")
                    {
            ...
            {
                if(btnChoiScript.btnChoiText[ctr].text== "PILIPINAS KONG MAHAL")
                {
        ...
        else if(hint1==1)
        {
            for(int ctr=0; ctr<btnConScript.btnContainer.Length; ctr++)
            {
                if(btnConScript.btnConText[ctr].text=="JOPAY")
                {
                    btnConScript.btnConText[ctr].text="";
                }
            ...
            for(int ctr=0; ctr<btnChoiScript.btnChoices.Length; ctr++)
            {
                if(btnChoiScript.btnChoiText[ctr].text=="JOPAY")
                {
                    btnChoiScript.btnChoices[ctr].SetActive(false);
                }
