using UnityEngine;
public class Hints44 : MonoBehaviour
{
    ...
    int hint1 = 0;
    string[] answer = { "MANGGANG MARIKIT" };
    ...
    public void HintClicked01()
    {
        ...
        {            
            for(int ctr=0; ctr<btnConScript.btnContainer.Length; ctr++)
            {
                ...
                {
                    if(btnConScript.btnConText[ctr].text== "MANGGANG DIKIT")
                    {
            ...
            {
                if(btnChoiScript.btnChoiText[ctr].text== "MANGGANG DIKIT")
                {
        ...
        else if(hint1==1)
        {
            for(int ctr=0; ctr<btnConScript.btnContainer.Length; ctr++)
            {
                if(btnConScript.btnConText[ctr].text== "PANIKI")
                {
                    btnConScript.btnConText[ctr].text="";
                }
            ...
            for(int ctr=0; ctr<btnChoiScript.btnChoices.Length; ctr++)
            {
                if(btnChoiScript.btnChoiText[ctr].text== "PANIKI")
                {
                    btnChoiScript.btnChoices[ctr].SetActive(false);
                }
