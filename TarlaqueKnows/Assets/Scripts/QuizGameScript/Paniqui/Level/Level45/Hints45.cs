...
public class Hints45 : MonoBehaviour
{
    public GameObject btnChoiParent;
    ButtonChoices45 btnChoiScript;
    public GameObject btnConParent;
    ButtonContainer45 btnConScript;
    int hint1 = 0;
    string[] answer = {"T","A","M","B","O","L","A","K","E"};
    ...
    void Start()
    {
        btnChoiScript = btnChoiParent.GetComponent<ButtonChoices45>();
        btnConScript = btnConParent.GetComponent<ButtonContainer45>();
    ...
    public void HintClicked01()
    {
        ...
        {            
            for(int ctr=0; ctr<btnConScript.btnContainer.Length; ctr++)
            {
                ...
                {
                    if(btnConScript.btnConText[ctr].text=="R")
                    {
                    ...
                    if (btnConScript.btnConText[ctr].text == "Y")
                    {
                        btnConScript.btnConText[ctr].text = "";
                    }
            ...
            {
                if(btnChoiScript.btnChoiText[ctr].text=="R")
                {
                ...
                if (btnChoiScript.btnChoiText[ctr].text == "Y")
                {
                    btnChoiScript.btnChoices[ctr].SetActive(false);
                }
