...
public class Hints65 : MonoBehaviour
{
    public GameObject btnChoiParent;
    ButtonChoices65 btnChoiScript;
    public GameObject btnConParent;
    ButtonContainer65 btnConScript;
    int hint1 = 0;
    string[] answer = {"A","N","C","E","S","T","R","A","L","H","O","U","S","E"};
    ...
    void Start()
    {
        btnChoiScript = btnChoiParent.GetComponent<ButtonChoices65>();
        btnConScript = btnConParent.GetComponent<ButtonContainer65>();
