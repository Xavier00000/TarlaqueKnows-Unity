...
public class ChoicesClicked63 : MonoBehaviour
{
    public GameObject btnChoiParent;
    ButtonChoices63 btnChoiScript;
    public GameObject btnConParent;
    ButtonContainer63 btnConScript;
    public GameObject hintsObj;
    Hints63 hintScript;
    void Start()
    {
        btnChoiScript = btnChoiParent.GetComponent<ButtonChoices63>();
        btnConScript = btnConParent.GetComponent<ButtonContainer63>();
        hintScript = hintsObj.GetComponent<Hints63>();
    }
