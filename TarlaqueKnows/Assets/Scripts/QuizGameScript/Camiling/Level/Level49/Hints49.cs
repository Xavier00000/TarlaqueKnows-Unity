...
public class Hints49 : MonoBehaviour
{
    public GameObject btnChoiParent;
    ButtonChoices49 btnChoiScript;
    public GameObject btnConParent;
    ButtonContainer49 btnConScript;
    int hint1 = 0;
    string[] answer = {"C","H","I","C","H","A","R","O","N"};
    ...
    void Start()
    {
        btnChoiScript = btnChoiParent.GetComponent<ButtonChoices49>();
        btnConScript = btnConParent.GetComponent<ButtonContainer49>();
        ...
        {            
            for(int ctr=0; ctr<btnConScript.btnContainer.Length; ctr++)
            {
                for(int ctr2=0; ctr2<btnChoiScript.btnChoices.Length; ctr2++)
                {
                    ...
                    if (btnConScript.btnConText[ctr].text == "K")
                    {
                        btnConScript.btnConText[ctr].text = "";
                    }
                    if (btnConScript.btnConText[ctr].text == "A")
                    {
                        btnConScript.btnConText[ctr].text = "";
                    }
            ...
            for(int ctr=0; ctr<btnChoiScript.btnChoices.Length; ctr++)
            {
                ...
                if (btnChoiScript.btnChoiText[ctr].text == "K")
                {
                    btnChoiScript.btnChoices[ctr].SetActive(false);
                }
                if (btnChoiScript.btnChoiText[ctr].text == "A")
                {
                    btnChoiScript.btnChoices[ctr].SetActive(false);
                }
