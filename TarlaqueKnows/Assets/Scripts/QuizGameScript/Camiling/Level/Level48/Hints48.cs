using UnityEngine;
public class Hints48 : MonoBehaviour
{
    ...
    public void HintClicked01()
    {
        ...
        {            
            for(int ctr=0; ctr<btnConScript.btnContainer.Length; ctr++)
            {
                ...
                {
                    if(btnConScript.btnConText[ctr].text== "CAMIRONG")
                    {
            ...
            {
                if(btnChoiScript.btnChoiText[ctr].text== "CAMIRONG")
                {
        ...
        else if(hint1==1)
        {
            for(int ctr=0; ctr<btnConScript.btnContainer.Length; ctr++)
            {
                if(btnConScript.btnConText[ctr].text== "CAMISING")
                {
                    btnConScript.btnConText[ctr].text="";
                }
            ...
            for(int ctr=0; ctr<btnChoiScript.btnChoices.Length; ctr++)
            {
                if(btnChoiScript.btnChoiText[ctr].text== "CAMISING")
                {
                    btnChoiScript.btnChoices[ctr].SetActive(false);
                }
