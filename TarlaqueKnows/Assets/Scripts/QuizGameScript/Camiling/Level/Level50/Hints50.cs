using UnityEngine;
public class Hints50 : MonoBehaviour
{
    ...
    public void HintClicked01()
    {
        ...
        if (hint1 == 0)
        {
            for (int ctr = 0; ctr < btnConScript.btnContainer.Length; ctr++)
            {
                ...
                {
                    if (btnConScript.btnConText[ctr].text == "TAGALOG TRIBES")
                    {
            ...
            {
                if (btnChoiScript.btnChoiText[ctr].text == "TAGALOG TRIBES")
                {
        ...
        else if (hint1 == 1)
        {
            for (int ctr = 0; ctr < btnConScript.btnContainer.Length; ctr++)
            {
                if (btnConScript.btnConText[ctr].text == "MALAY TRIBES")
                {
                    btnConScript.btnConText[ctr].text = "";
                }
            ...
            for (int ctr = 0; ctr < btnChoiScript.btnChoices.Length; ctr++)
            {
                if (btnChoiScript.btnChoiText[ctr].text == "MALAY TRIBES")
                {
                    btnChoiScript.btnChoices[ctr].SetActive(false);
                }
