...
public class ButtonContainer61 : MonoBehaviour
{
    public GameObject[] btnContainer;
    public Text[] btnConText;
    public GameObject AllParent;
    SceneChangeEL61 GameObjectScript;

    void Start()
    {
        GameObjectScript = AllParent.GetComponent<SceneChangeEL61>();
    }
    public void IsCorrect()
    {
        for(int ctr=0; ctr<btnContainer.Length;)
            ...
            if (btnConText[ctr].text != null && btnConText[ctr].text == "")
            {
                ...
                else if(btnConText[0].text=="P" && btnConText[1].text=="I" && btnConText[2].text=="K" && btnConText[3].text=="K" && btnConText[4].text== "A"  && btnConText[5].text == "N" && 
                btnConText[6].text == "F" && btnConText[7].text == "A" && btnConText[8].text == "L" && btnConText[9].text == "L" && btnConText[10].text == "S")
                {
                    GameObjectScript.Animation.Play("Show_Info");
                    FinishedLevel.isLevelFinished[60]=true;
                ...
                HintPoints.trials=0;
                    ...
                    btnConText[3].text == "" || btnConText[4].text == "" || btnConText[5].text == ""
                     || btnConText[6].text == "" || btnConText[7].text == "" || btnConText[8].text == "" || btnConText[9].text == "" || btnConText[10].text == "")
            {
                    btnConText[0].color = Color.white;
                    btnConText[1].color = Color.white;
                    btnConText[2].color = Color.white;
