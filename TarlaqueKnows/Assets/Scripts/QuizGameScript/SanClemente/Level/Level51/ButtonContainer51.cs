...
public class ButtonContainer51 : MonoBehaviour
{
    public GameObject[] btnContainer;
    public Text[] btnConText;
    public GameObject AllParent;
    SceneChangeEL51 GameObjectScript;

    void Start()
    {
        GameObjectScript = AllParent.GetComponent<SceneChangeEL51>();
    }
        ...
        for(int ctr=0; ctr<btnContainer.Length; )
            {
                ...
                else if(btnConText[0].text=="C" && btnConText[1].text=="A" && btnConText[2].text=="N" && btnConText[3].text == "D" && btnConText[4].text == "I" && btnConText[5].text == "N" && btnConText[6].text == "G" 
                && btnConText[7].text == "F" && btnConText[8].text == "A" && btnConText[9].text == "L" && btnConText[10].text == "L" && btnConText[11].text == "S")
            {
                    GameObjectScript.Animation.Play("Show_Info");
                FinishedLevel.isLevelFinished[50] = true;
                ...
                HintPoints.trials=0;
                    ...
                    btnConText[3].text == "" || btnConText[4].text == "" || btnConText[5].text == "" || btnConText[6].text == "" ||
                    btnConText[7].text == "" || btnConText[8].text == "" || btnConText[9].text == "" || btnConText[10].text == "" ||
                    btnConText[11].text == "")
            {
                btnConText[0].color = Color.white;
                btnConText[1].color = Color.white;
