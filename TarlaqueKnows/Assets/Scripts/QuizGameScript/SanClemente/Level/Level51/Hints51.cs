...
public class Hints51 : MonoBehaviour
{
    public GameObject btnChoiParent;
    ButtonChoices51 btnChoiScript;
    public GameObject btnConParent;
    ButtonContainer51 btnConScript;
    int hint1 = 0;
    string[] answer = {"C","A","N", "D", "I", "N", "G", "F", "A","L","L","S" };
    ...
    void Start()
    {
        btnChoiScript = btnChoiParent.GetComponent<ButtonChoices51>();
        btnConScript = btnConParent.GetComponent<ButtonContainer51>();
