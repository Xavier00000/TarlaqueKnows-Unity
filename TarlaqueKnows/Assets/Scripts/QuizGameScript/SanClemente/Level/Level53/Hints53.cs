...
public class Hints53 : MonoBehaviour
{
    public GameObject btnChoiParent;
    ButtonChoices53 btnChoiScript;
    public GameObject btnConParent;
    ButtonContainer53 btnConScript;
    int hint1 = 0;
    string[] answer = {"S","U","G","A","R","C","A","N","E"};
    ...
    void Start()
    {
        btnChoiScript = btnChoiParent.GetComponent<ButtonChoices53>();
        btnConScript = btnConParent.GetComponent<ButtonContainer53>();
