using UnityEngine;
public class Hints54 : MonoBehaviour
{
    ...
    public void HintClicked01()
    {
        ...
        if (hint1 == 0)
        {
            for (int ctr = 0; ctr < btnConScript.btnContainer.Length; ctr++)
            {
                ...
                {
                    if (btnConScript.btnConText[ctr].text == "PALAT FESTIVAL")
                    {
            ...
            {
                if (btnChoiScript.btnChoiText[ctr].text == "PALAT FESTIVAL")
                {
        ...
        else if (hint1 == 1)
        {
            for (int ctr = 0; ctr < btnConScript.btnContainer.Length; ctr++)
            {
                if (btnConScript.btnConText[ctr].text == "WALIS FESTIVAL")
                {
                    btnConScript.btnConText[ctr].text = "";
                }
            ...
            for (int ctr = 0; ctr < btnChoiScript.btnChoices.Length; ctr++)
            {
                if (btnChoiScript.btnChoiText[ctr].text == "WALIS FESTIVAL")
                {
                    btnChoiScript.btnChoices[ctr].SetActive(false);
                }
