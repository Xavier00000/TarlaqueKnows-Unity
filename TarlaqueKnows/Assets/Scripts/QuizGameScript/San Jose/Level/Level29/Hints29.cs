...
public class Hints29 : MonoBehaviour
{
    public GameObject btnChoiParent;
    ButtonChoices29 btnChoiScript;
    public GameObject btnConParent;
    ButtonContainer29 btnConScript;
    int hint1 = 0;
    string[] answer = {"S","I","T","I","O","B","A","A","G"};
    ...
    void Start()
    {
        btnChoiScript = btnChoiParent.GetComponent<ButtonChoices29>();
        btnConScript = btnConParent.GetComponent<ButtonContainer29>();
