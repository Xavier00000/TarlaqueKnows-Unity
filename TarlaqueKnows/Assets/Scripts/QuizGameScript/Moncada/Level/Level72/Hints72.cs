using UnityEngine;
public class Hints72 : MonoBehaviour
{
    public GameObject btnChoiParent;
    ButtonChoices72 btnChoiScript;
    public GameObject btnConParent;
    ButtonContainer72 btnConScript;
    int hint1 = 0;
    string[] answer = { "MUSCADA" };
    ...
    void Start()
    {
        btnChoiScript = btnChoiParent.GetComponent<ButtonChoices72>();
        btnConScript = btnConParent.GetComponent<ButtonContainer72>();
    ...
    public void HintClicked01()
    {
        ...
        {            
            for(int ctr=0; ctr<btnConScript.btnContainer.Length; ctr++)
            {
                ...
                {
                    if(btnConScript.btnConText[ctr].text== "MASCADO")
                    {
            ...
            {
                if(btnChoiScript.btnChoiText[ctr].text== "MASCADO")
                {
        ...
        else if(hint1==1)
        {
            for(int ctr=0; ctr<btnConScript.btnContainer.Length; ctr++)
            {
                if(btnConScript.btnConText[ctr].text== "MURILO")
                {
                    btnConScript.btnConText[ctr].text="";
                }
            ...
            for(int ctr=0; ctr<btnChoiScript.btnChoices.Length; ctr++)
            {
                if(btnChoiScript.btnChoiText[ctr].text== "MURILO")
                {
                    btnChoiScript.btnChoices[ctr].SetActive(false);
                }
