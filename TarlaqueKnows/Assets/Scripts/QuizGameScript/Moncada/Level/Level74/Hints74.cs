using UnityEngine;
public class Hints74 : MonoBehaviour
{
    ...
    int hint1 = 0;
    string[] answer = { "DON FRUTO TINTIANCO" };
    ...
    public void HintClicked01()
    {
        ...
        if (hint1 == 0)
        {
            for (int ctr = 0; ctr < btnConScript.btnContainer.Length; ctr++)
            {
                ...
                {
                    if (btnConScript.btnConText[ctr].text == "DAN FRUIT TINTIANCO")
                    {
            ...
            {
                if (btnChoiScript.btnChoiText[ctr].text == "DAN FRUIT TINTIANCO")
                {
        ...
        else if (hint1 == 1)
        {
            for (int ctr = 0; ctr < btnConScript.btnContainer.Length; ctr++)
            {
                if (btnConScript.btnConText[ctr].text == "DON FRUIT TINTIANCO")
                {
                    btnConScript.btnConText[ctr].text = "";
                }
            ...
            for (int ctr = 0; ctr < btnChoiScript.btnChoices.Length; ctr++)
            {
                if (btnChoiScript.btnChoiText[ctr].text == "DON FRUIT TINTIANCO")
                {
                    btnChoiScript.btnChoices[ctr].SetActive(false);
                }
