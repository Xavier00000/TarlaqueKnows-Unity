...
public class Hints73 : MonoBehaviour
{
    public GameObject btnChoiParent;
    ButtonChoices73 btnChoiScript;
    public GameObject btnConParent;
    ButtonContainer73 btnConScript;
    int hint1 = 0;
    string[] answer = {"M","O","R","A","L","E","S","H","O","U","S","E"};
    ...
    void Start()
    {
        btnChoiScript = btnChoiParent.GetComponent<ButtonChoices73>();
        btnConScript = btnConParent.GetComponent<ButtonContainer73>();
