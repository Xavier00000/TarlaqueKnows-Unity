...
public class ButtonContainer71 : MonoBehaviour
{
    public GameObject[] btnContainer;
    public Text[] btnConText;
    public GameObject AllParent;
    SceneChangeEL71 GameObjectScript;

    void Start()
    {
        GameObjectScript = AllParent.GetComponent<SceneChangeEL71>();
    }
        ...
        for(int ctr=0; ctr<btnContainer.Length; )
            {
                ...
                else if(btnConText[0].text == "L" && btnConText[1].text == "U" && btnConText[2].text == "I" && btnConText[3].text == "S" && 
                btnConText[4].text == "M" && btnConText[5].text == "O" && btnConText[6].text == "R" && btnConText[7].text == "A" && btnConText[8].text == "L" && btnConText[9].text == "E" && btnConText[10].text == "S" && 
                btnConText[11].text == "P" && btnConText[12].text == "A" && btnConText[13].text == "R" && btnConText[14].text == "K")
            {
                    GameObjectScript.Animation.Play("Show_Info");
                FinishedLevel.isLevelFinished[70] = true;
                ...
                HintPoints.trials=0;
                    ...
                    btnConText[3].text == "" || btnConText[4].text == "" || btnConText[5].text == ""
                     ...
                     btnConText[12].text == "" || btnConText[13].text == "" || btnConText[14].text == "")
            {
                btnConText[0].color = Color.white;
                btnConText[1].color = Color.white;
                btnConText[2].color = Color.white;
