...
public class ChoicesClicked71 : MonoBehaviour
{
    public GameObject btnChoiParent;
    ButtonChoices71 btnChoiScript;
    public GameObject btnConParent;
    ButtonContainer71 btnConScript;
    public GameObject hintsObj;
    Hints71 hintScript;
    void Start()
    {
        btnChoiScript = btnChoiParent.GetComponent<ButtonChoices71>();
        btnConScript = btnConParent.GetComponent<ButtonContainer71>();
        hintScript = hintsObj.GetComponent<Hints71>();
    }
