...
public class Hints14 : MonoBehaviour
{
    ...
    int hint1 = 0;
    string[] answer = { "DON MANUEL SEQUIG" };
    ...
    public void HintClicked01()
    {
        ...
        {            
            for(int ctr=0; ctr<btnConScript.btnContainer.Length; ctr++)
            {
                ...
                {
                    if(btnConScript.btnConText[ctr].text== "EDUARDINO")
                    {
            ...
            {
                if(btnChoiScript.btnChoiText[ctr].text== "EDUARDINO")
                {
        ...
        else if(hint1==1)
        {
            for(int ctr=0; ctr<btnConScript.btnContainer.Length; ctr++)
            {
                if(btnConScript.btnConText[ctr].text== "MANNY")
                {
                    btnConScript.btnConText[ctr].text="";
                }
            ...
            for(int ctr=0; ctr<btnChoiScript.btnChoices.Length; ctr++)
            {
                if(btnChoiScript.btnChoiText[ctr].text== "MANNY")
                {
                    btnChoiScript.btnChoices[ctr].SetActive(false);
                }
