...
public class ButtonContainer33 : MonoBehaviour
{
    ...
    SceneChangeEL33 GameObjectScript;
    ...
    void Start()
    {
        GameObjectScript = AllParent.GetComponent<SceneChangeEL33>();
    }
    public void IsCorrect()
    {
        for(int ctr=0; ctr<btnContainer.Length;)
            ...
            if (btnConText[ctr].text != null && btnConText[ctr].text == "")
            {
                ...
                else if(btnConText[0].text=="D" && btnConText[1].text=="R" && btnConText[2].text=="A" && btnConText[3].text=="G" && btnConText[4].text== "O"  && btnConText[5].text == "N" 
                && btnConText[6].text == "F" && btnConText[7].text == "R" && btnConText[8].text == "U" && btnConText[9].text == "I" && btnConText[10].text == "T" )
                {
