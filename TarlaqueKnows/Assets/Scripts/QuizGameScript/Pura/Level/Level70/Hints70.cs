using UnityEngine;
public class Hints70 : MonoBehaviour
{
    public GameObject btnChoiParent;
    ButtonChoices70 btnChoiScript;
    public GameObject btnConParent;
    ButtonContainer70 btnConScript;
    int hint1 = 0;
    string[] answer = { "PURA" };
    ...
    void Start()
    {
        btnChoiScript = btnChoiParent.GetComponent<ButtonChoices70>();
        btnConScript = btnConParent.GetComponent<ButtonContainer70>();
    ...
    public void HintClicked01()
    {
        ...
        {            
            for(int ctr=0; ctr<btnConScript.btnContainer.Length; ctr++)
            {
                ...
                {
                    if(btnConScript.btnConText[ctr].text== "SAN JOSE")
                    {
            ...
            {
                if(btnChoiScript.btnChoiText[ctr].text== "SAN JOSE")
                {
        ...
        else if(hint1==1)
        {
            for(int ctr=0; ctr<btnConScript.btnContainer.Length; ctr++)
            {
                if(btnConScript.btnConText[ctr].text== "SAN MANUEL")
                {
                    btnConScript.btnConText[ctr].text="";
                }
            ...
            for(int ctr=0; ctr<btnChoiScript.btnChoices.Length; ctr++)
            {
                if(btnChoiScript.btnChoiText[ctr].text== "SAN MANUEL")
                {
                    btnChoiScript.btnChoices[ctr].SetActive(false);
                }
