using UnityEngine;
public class Hints68 : MonoBehaviour
{
    ...
    public void HintClicked01()
    {
        ...
        {            
            for(int ctr=0; ctr<btnConScript.btnContainer.Length; ctr++)
            {
                ...
                {
                    if(btnConScript.btnConText[ctr].text== "PARTNERSHIP")
                    {
            ...
            {
                if(btnChoiScript.btnChoiText[ctr].text== "PARTNERSHIP")
                {
        ...
        else if(hint1==1)
        {
            for(int ctr=0; ctr<btnConScript.btnContainer.Length; ctr++)
            {
                if(btnConScript.btnConText[ctr].text== "RELATIONSHIP")
                {
                    btnConScript.btnConText[ctr].text="";
                }
            ...
            for(int ctr=0; ctr<btnChoiScript.btnChoices.Length; ctr++)
            {
                if(btnChoiScript.btnChoiText[ctr].text== "RELATIONSHIP")
                {
                    btnChoiScript.btnChoices[ctr].SetActive(false);
                }
