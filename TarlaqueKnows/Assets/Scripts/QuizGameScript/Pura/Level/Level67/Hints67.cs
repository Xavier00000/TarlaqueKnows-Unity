using UnityEngine;
public class Hints67 : MonoBehaviour
{
    public GameObject btnChoiParent;
    ButtonChoices67 btnChoiScript;
    public GameObject btnConParent;
    ButtonContainer67 btnConScript;
    int hint1 = 0;
    string[] answer = { "FOURTH" };
    ...
    void Start()
    {
        btnChoiScript = btnChoiParent.GetComponent<ButtonChoices67>();
        btnConScript = btnConParent.GetComponent<ButtonContainer67>();
    ...
    public void HintClicked01()
    {
        ...
        {            
            for(int ctr=0; ctr<btnConScript.btnContainer.Length; ctr++)
            {
                ...
                {
                    if(btnConScript.btnConText[ctr].text== "THIRD")
                    {
            ...
            {
                if(btnChoiScript.btnChoiText[ctr].text== "THIRD")
                {
        ...
        else if(hint1==1)
        {
            for(int ctr=0; ctr<btnConScript.btnContainer.Length; ctr++)
            {
                if(btnConScript.btnConText[ctr].text== "FIRST")
                {
                    btnConScript.btnConText[ctr].text="";
                }
            ...
            for(int ctr=0; ctr<btnChoiScript.btnChoices.Length; ctr++)
            {
                if(btnChoiScript.btnChoiText[ctr].text== "FIRST")
                {
                    btnChoiScript.btnChoices[ctr].SetActive(false);
                }
