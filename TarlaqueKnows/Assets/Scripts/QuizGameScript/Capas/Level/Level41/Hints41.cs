...
public class Hints41 : MonoBehaviour
{
    public GameObject btnChoiParent;
    ButtonChoices41 btnChoiScript;
    public GameObject btnConParent;
    ButtonContainer41 btnConScript;
    int hint1 = 0;
    ...
    void Start()
    {
        btnChoiScript = btnChoiParent.GetComponent<ButtonChoices41>();
        btnConScript = btnConParent.GetComponent<ButtonContainer41>();
