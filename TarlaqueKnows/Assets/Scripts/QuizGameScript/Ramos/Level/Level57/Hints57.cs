...
public class Hints57 : MonoBehaviour
{
    public GameObject btnChoiParent;
    ButtonChoices57 btnChoiScript;
    public GameObject btnConParent;
    ButtonContainer57 btnConScript;
    int hint1 = 0;
    string[] answer = {"R","A","M","O","S","P","L","A","Z","A"};
    ...
    void Start()
    {
        btnChoiScript = btnChoiParent.GetComponent<ButtonChoices57>();
        btnConScript = btnConParent.GetComponent<ButtonContainer57>();
