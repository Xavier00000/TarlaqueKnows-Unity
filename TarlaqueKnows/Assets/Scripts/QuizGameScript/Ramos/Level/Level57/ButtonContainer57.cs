...
public class ButtonContainer57 : MonoBehaviour
{
    public GameObject[] btnContainer;
    public Text[] btnConText;
    public GameObject AllParent;
    SceneChangeEL57 GameObjectScript;

    void Start()
    {
        GameObjectScript = AllParent.GetComponent<SceneChangeEL57>();
    }
    public void IsCorrect()
    {
        for(int ctr=0; ctr<btnContainer.Length;)
            ...
            if (btnConText[ctr].text != null && btnConText[ctr].text == "")
            {
                ...
                else if(btnConText[0].text=="R" && btnConText[1].text=="A" && btnConText[2].text=="M" && btnConText[3].text=="O" && btnConText[4].text== "S"  
                && btnConText[5].text == "P" && btnConText[6].text == "L" && btnConText[7].text == "A" && btnConText[8].text == "Z" && btnConText[9].text == "A")
                {
                    GameObjectScript.Animation.Play("Show_Info");
                    FinishedLevel.isLevelFinished[56]=true;
