using UnityEngine;
public class Hints31 : MonoBehaviour
{
    public GameObject btnChoiParent;
    ButtonChoices31 btnChoiScript;
    public GameObject btnConParent;
    ButtonContainer31 btnConScript;
    string[] answer = {"E","A","R","T","H","Q","U","A","K","E"};
    bool[] isAlreadyAnswer = new bool[10];
    ...
    void Start()
    {
        btnChoiScript = btnChoiParent.GetComponent<ButtonChoices31>();
        btnConScript = btnConParent.GetComponent<ButtonContainer31>();
    ...
    public void HintClicked01()
    {
        ...
        {            
            for(int ctr=0; ctr<btnConScript.btnContainer.Length; ctr++)
            {
                ...
                {
                    if(btnConScript.btnConText[ctr].text=="P")
                    {
                        btnConScript.btnConText[ctr].text="";
                    }
                    if(btnConScript.btnConText[ctr].text=="S")
                    {
                        btnConScript.btnConText[ctr].text="";
                    }
                }                           
            ...
            {
                if(btnChoiScript.btnChoiText[ctr].text=="P")
                {
                    btnChoiScript.btnChoices[ctr].SetActive(false);
                }
                if(btnChoiScript.btnChoiText[ctr].text=="S")
                {
                    btnChoiScript.btnChoices[ctr].SetActive(false);
                }
            }
    ...
    {        
        if(HintPoints.HintsPoints>=80 && numTap<1)
        {
