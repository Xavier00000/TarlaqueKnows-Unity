...
public class LevelForTarlac : MonoBehaviour
{
    ...
    public GameObject TarlacCity, Bamban, SanManuel, Conception, Gerona, Anao, SanJose, Victoria, Mayantoc, Capas, Paniqui, Camiling, SanClemente, Ramos, StaIgnacia, LaPaz, Pura, Moncada;
    ...
    void Start()
    {
        ...
        if (FinishedLevel.isLevelFinished[8])
        {
        ...
        if (FinishedLevel.isLevelFinished[9])
        {
            LockedPanel[levelToCheck9].SetActive(false);
        }
        if (FinishedLevel.isLevelFinished[10])
        {
            LockedPanel[levelToCheck10].SetActive(false);
        }
        if (FinishedLevel.isLevelFinished[11])
        {
            LockedPanel[levelToCheck11].SetActive(false);
        }
        if (FinishedLevel.isLevelFinished[12])
        {
        ...
        if (FinishedLevel.isLevelFinished[13])
        {
            LockedPanel[levelToCheck13].SetActive(false);
        }
        if (FinishedLevel.isLevelFinished[14])
        {
            LockedPanel[levelToCheck14].SetActive(false);
        }
        if (FinishedLevel.isLevelFinished[15])
        {
            LockedPanel[levelToCheck15].SetActive(false);
        }
        if (FinishedLevel.isLevelFinished[16])
        {
        ...
        if (FinishedLevel.isLevelFinished[17])
        {
            LockedPanel[levelToCheck17].SetActive(false);
        }
        if (FinishedLevel.isLevelFinished[18])
        {
            LockedPanel[levelToCheck18].SetActive(false);
        }
        if (FinishedLevel.isLevelFinished[19])
        {
            LockedPanel[levelToCheck19].SetActive(false);
        }
        if (FinishedLevel.isLevelFinished[20])
        {
