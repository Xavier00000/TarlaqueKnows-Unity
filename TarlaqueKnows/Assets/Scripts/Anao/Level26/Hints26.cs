using UnityEngine;
public class Hints26 : MonoBehaviour
{
    public GameObject btnChoiParent;
    ButtonChoices26 btnChoiScript;
    public GameObject btnConParent;
    ButtonContainer26 btnConScript;
    int hint1 = 0;
    string[] answer = { "ANAO" };
    ...
    void Start()
    {
        btnChoiScript = btnChoiParent.GetComponent<ButtonChoices26>();
        btnConScript = btnConParent.GetComponent<ButtonContainer26>();
    ...
    public void HintClicked01()
    {
        ...
        else if(hint1==1)
        {
            for(int ctr=0; ctr<btnConScript.btnContainer.Length; ctr++)
            {
                if(btnConScript.btnConText[ctr].text== "PANIQUI")
                {
                    btnConScript.btnConText[ctr].text="";
                }
            ...
            for(int ctr=0; ctr<btnChoiScript.btnChoices.Length; ctr++)
            {
                if(btnChoiScript.btnChoiText[ctr].text== "PANIQUI")
                {
                    btnChoiScript.btnChoices[ctr].SetActive(false);
                }
