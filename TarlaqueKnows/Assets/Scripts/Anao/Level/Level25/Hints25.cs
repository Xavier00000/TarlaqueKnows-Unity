...
public class Hints25 : MonoBehaviour
{
    public GameObject btnChoiParent;
    ButtonChoices25 btnChoiScript;
    public GameObject btnConParent;
    ButtonContainer25 btnConScript;
    int hint1 = 0;
    string[] answer = {"Y","L","A","N","G","Y","L","A","N","G"};
    ...
    void Start()
    {
        btnChoiScript = btnChoiParent.GetComponent<ButtonChoices25>();
        btnConScript = btnConParent.GetComponent<ButtonContainer25>();
