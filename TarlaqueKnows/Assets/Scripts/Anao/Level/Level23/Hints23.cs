...
public class Hints23 : MonoBehaviour
{
    public GameObject btnChoiParent;
    ButtonChoices23 btnChoiScript;
    public GameObject btnConParent;
    ButtonContainer23 btnConScript;
    int hint1 = 0;
    string[] answer = {"P","A","N","C","I","T","A","N","A","O"};
    ...
    void Start()
    {
        btnChoiScript = btnChoiParent.GetComponent<ButtonChoices23>();
        btnConScript = btnConParent.GetComponent<ButtonContainer23>();
