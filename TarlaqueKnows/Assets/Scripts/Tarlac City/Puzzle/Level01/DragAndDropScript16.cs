...
public class DragAndDropScript16 : MonoBehaviour
{
    ...
    public void isCorrect()
    {
        for(int ctr=0; ctr<isAlreadyCorrect.Length; ctr++)
        {
            ...
            {
                anim.Play("Show_Info");
                FinishedLevelP.isLevelFinished[0]=true;
    ...
    public void dropImage()
    {
        ...
        float[] containerDistance = new float[8];
