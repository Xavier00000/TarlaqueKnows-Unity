        ...
        for(int ctr=0; ctr<btnContainer.Length; ctr++)
            {
                ...
                else if(btnConText[0].text=="F" && btnConText[1].text=="A"
                    && btnConText[2].text=="C" && btnConText[3].text=="T"
                    && btnConText[4].text=="O"&& btnConText[5].text=="R"
                    && btnConText[6].text=="I" && btnConText[7].text=="A"
                    && btnConText[8].text=="L")
                {                    
