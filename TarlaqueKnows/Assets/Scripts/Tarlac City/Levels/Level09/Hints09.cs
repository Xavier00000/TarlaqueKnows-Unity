using UnityEngine;
public class Hints09 : MonoBehaviour
{
    public GameObject btnChoiParent;
    ButtonChoices09 btnChoiScript;
    public GameObject btnConParent;
    ButtonContainer09 btnConScript;
    string[] answer = {"E","M","P","T","Y","S","E","T"};
    ...
    void Start()
    {
        btnChoiScript = btnChoiParent.GetComponent<ButtonChoices09>();
        btnConScript = btnConParent.GetComponent<ButtonContainer09>();
