using UnityEngine;
public class Hints32 : MonoBehaviour
{
    ...
    public void HintClicked01()
    {
        ...
        {            
            for(int ctr=0; ctr<btnConScript.btnContainer.Length; ctr++)
            {
                ...
                {
                    if(btnConScript.btnConText[ctr].text=="BULO LAKE")
                    {
            ...
            {
                if(btnChoiScript.btnChoiText[ctr].text== "BULO LAKE")
                {
        ...
        else if(hint1==1)
        {
            for(int ctr=0; ctr<btnConScript.btnContainer.Length; ctr++)
            {
                if(btnConScript.btnConText[ctr].text== "BANGAR LAKE")
                {
                    btnConScript.btnConText[ctr].text="";
                }
            ...
            for(int ctr=0; ctr<btnChoiScript.btnChoices.Length; ctr++)
            {
                if(btnChoiScript.btnChoiText[ctr].text== "BANGAR LAKE")
                {
                    btnChoiScript.btnChoices[ctr].SetActive(false);
                }
