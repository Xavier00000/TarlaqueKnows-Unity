...
public class SceneChangeNL23 : MonoBehaviour
{
    public Animator Animation;
    public GameObject BackWarnBox;
    public Hints23 HintScript;
    void Start()
    {
        if(FinishedLevel.isFinishedAnimation[7]==true)
        {
        ...
        FinishedLevel.isFinishedAnimation[7]=true;
    }
    public void FadeOut()
    {
