...
public class SceneChangeNL19 : MonoBehaviour
{
    public Animator Animation;
    public GameObject BackWarnBox;
    public Hints19 HintScript;
    void Start()
    {
        if(FinishedLevel.isFinishedAnimation[3]==true)
        {
        ...
        FinishedLevel.isFinishedAnimation[3]=true;
    }
    public void FadeOut()
    {
