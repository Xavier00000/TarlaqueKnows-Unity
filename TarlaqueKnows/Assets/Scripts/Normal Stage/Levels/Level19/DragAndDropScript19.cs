...
public class DragAndDropScript19 : MonoBehaviour
{
    public GameObject[] ImageChoices;
    public GameObject[] ImageContainer;
    public Vector2[] ImagePosition = new Vector2[10];
    public bool[] isAlreadyCorrect = new bool[10];
    ...
    public void dropImage()
    {
        ...
        float[] containerDistance = new float[9];
