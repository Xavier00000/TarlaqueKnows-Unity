...
public class SceneChangeNL21 : MonoBehaviour
{
    public Animator Animation;
    public GameObject BackWarnBox;
    public Hints21 HintScript;
    void Start()
    {
        if(FinishedLevel.isFinishedAnimation[5]==true)
        {
        ...
        FinishedLevel.isFinishedAnimation[5]=true;
    }
    public void FadeOut()
    {
