...
public class SceneChangeNL24 : MonoBehaviour
{
    public Animator Animation;
    public GameObject BackWarnBox;
    public Hints24 HintScript;
    void Start()
    {
        if(FinishedLevel.isFinishedAnimation[8]==true)
        {
        ...
        FinishedLevel.isFinishedAnimation[8]=true;
    }
    public void FadeOut()
    {
