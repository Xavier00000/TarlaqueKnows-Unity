...
public class SceneChangeNL22 : MonoBehaviour
{
    public Animator Animation;
    public GameObject BackWarnBox;
    public Hints22 HintScript;
    void Start()
    {
        if(FinishedLevel.isFinishedAnimation[6]==true)
        {
        ...
        FinishedLevel.isFinishedAnimation[6]=true;
    }
    public void FadeOut()
    {
