...
public class SceneChangeNL18 : MonoBehaviour
{
    public Animator Animation;
    public GameObject BackWarnBox;
    public Hints18 HintScript;
    void Start()
    {
        if(FinishedLevel.isFinishedAnimation[2]==true)
        {
        ...
        FinishedLevel.isFinishedAnimation[2]=true;
    }
    public void FadeOut()
    {
