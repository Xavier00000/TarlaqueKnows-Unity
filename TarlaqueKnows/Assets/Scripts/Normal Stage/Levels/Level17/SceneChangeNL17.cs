...
public class SceneChangeNL17 : MonoBehaviour
{
    public Animator Animation;
    public GameObject BackWarnBox;
    public Hints17 HintScript;
    void Start()
    {
        if(FinishedLevel.isFinishedAnimation[1]==true)
        {
        ...
        FinishedLevel.isFinishedAnimation[1]=true;
    }
    public void FadeOut()
    {
