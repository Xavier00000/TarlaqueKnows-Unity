...
public class Hints43 : MonoBehaviour
{
    public GameObject btnChoiParent;
    ButtonChoices43 btnChoiScript;
    public GameObject btnConParent;
    ButtonContainer43 btnConScript;
    int hint1 = 0;
    string[] answer = {"M","T","T","E","L","A","K","A","W","A"};
    ...
    void Start()
    {
        btnChoiScript = btnChoiParent.GetComponent<ButtonChoices43>();
        btnConScript = btnConParent.GetComponent<ButtonContainer43>();
