...
public class Hints17 : MonoBehaviour
{
    public GameObject btnChoiParent;
    ButtonChoices17 btnChoiScript;
    public GameObject btnConParent;
    ButtonContainer17 btnConScript;
    int hint1 = 0;
    string[] answer = {"C","O","N","C","E","P","C","I","O","N","C","H","U","R","C","H"};
    ...
    void Start()
    {
        btnChoiScript = btnChoiParent.GetComponent<ButtonChoices17>();
        btnConScript = btnConParent.GetComponent<ButtonContainer17>();
