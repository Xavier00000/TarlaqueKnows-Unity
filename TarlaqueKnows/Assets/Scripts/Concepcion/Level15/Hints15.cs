...
public class Hints15 : MonoBehaviour
{
    public GameObject btnChoiParent;
    ButtonChoices15 btnChoiScript;
    public GameObject btnConParent;
    ButtonContainer15 btnConScript;
    int hint1 = 0;
    string[] answer = {"N","I","N","O","Y","A","Q","U","I","N","O"};
    bool[] isAlreadyAnswer = new bool[11];
    ...
    void Start()
    {
        btnChoiScript = btnChoiParent.GetComponent<ButtonChoices15>();
        btnConScript = btnConParent.GetComponent<ButtonContainer15>();
