using UnityEngine;
public class Hints28 : MonoBehaviour
{
    ...
    int hint1 = 0;
    string[] answer = { "TARLAC RECREATIONAL PARK" };
    ...
    public void HintClicked01()
    {
        ...
        {            
            for(int ctr=0; ctr<btnConScript.btnContainer.Length; ctr++)
            {
                ...
                {
                    if(btnConScript.btnConText[ctr].text=="YC COMPOUND")
                    {
            ...
            {
                if(btnChoiScript.btnChoiText[ctr].text== "YC COMPOUND")
                {
        ...
        else if(hint1==1)
        {
            for(int ctr=0; ctr<btnConScript.btnContainer.Length; ctr++)
            {
                if(btnConScript.btnConText[ctr].text== "CAPAS SHRINE")
                {
                    btnConScript.btnConText[ctr].text="";
                }
            ...
            for(int ctr=0; ctr<btnChoiScript.btnChoices.Length; ctr++)
            {
                if(btnChoiScript.btnChoiText[ctr].text== "CAPAS SHRINE")
                {
                    btnChoiScript.btnChoices[ctr].SetActive(false);
                }
