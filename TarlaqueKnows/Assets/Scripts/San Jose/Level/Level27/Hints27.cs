...
public class Hints27 : MonoBehaviour
{
    public GameObject btnChoiParent;
    ButtonChoices27 btnChoiScript;
    public GameObject btnConParent;
    ButtonContainer27 btnConScript;
    int hint1 = 0;
    string[] answer = {"L","I","M","I","A","C","P","A","R","K"};
    ...
    void Start()
    {
        btnChoiScript = btnChoiParent.GetComponent<ButtonChoices27>();
        btnConScript = btnConParent.GetComponent<ButtonContainer27>();
