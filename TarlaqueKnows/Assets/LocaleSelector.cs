...
namespace UnityEngine.Localization.Samples
{
    public class LocaleSelector : MonoBehaviour
    {
        ...
        void OnSelectionChanged(int index)
        {
            ...
            Debug.Log("current Selected local " + LocalizationSettings.SelectedLocale.LocaleName);

            //Here I'm using it
            LocalizationSettings.SelectedLocale = locale;

            Debug.Log("new Selected local " + LocalizationSettings.SelectedLocale.LocaleName);
